...
export const SidebarCreateItem: FC<SidebarCreateItemProps> = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent
        dir={dir}
        className="flex flex-col justify-between min-w-[450px] overflow-auto"
      ...
      >
        <div className="overflow-auto grow">
          <SheetHeader>
            <SheetTitle
              className={`font-bold text-2xl ${dir === "rtl" ? "text-right" : "text-left"}`}
            >
              {t(
          ...
          <div className="space-y-3 mt-4">{renderInputs()}</div>
        </div>
